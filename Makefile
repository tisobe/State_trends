...
BIN  = acorn state_mj_run.perl state_mj_script state_mj_size_check.perl state_mj_wrap_script state_sim_run.perl state_sim_script state_sim_wrap_script create_report_page_outputs.perl 
